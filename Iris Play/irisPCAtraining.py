...
if n_components==2:
    tree_pickle = 'tree_accuracies_pca2.pickle'
    neighbor_pickle = 'neighbor_accuracies_pca2.pickle'
    #split_pickle = 'splits.pickle'
    logRegression_pickle = 'logisticRegression_pca2.pickle'
    lda_pickle = 'lda_pca2.pickle'
    gaussian_pickle = 'gaussian_pca2.pickle'
    svc_pickle = 'svc_pca2.pickle'
elif n_components ==3:
    tree_pickle = 'tree_accuracies_pca3.pickle'
    neighbor_pickle = 'neighbor_accuracies_pca3.pickle'
    #split_pickle = 'splits.pickle'
    logRegression_pickle = 'logisticRegression_pca3.pickle'
    lda_pickle = 'lda_pca3.pickle'
    gaussian_pickle = 'gaussian_pca3.pickle'
    svc_pickle = 'svc_pca3.pickle'
