...
def drawMultipleScoreBarChart():

  # set width of bar
  barWidth = 0.25
  
  # set height of bar
  bars1 = scoresFrame['Accuracy'].tolist()
  bars2 = scoresFrame['Cross_Validation_Score'].tolist()
  ...
  plt.bar(r2, bars2, color='#557f2d', width=barWidth, edgecolor='white', label='Cross_Validation_Score')

  
  # Add xticks on the middle of the group bars
  plt.xlabel('Models', fontweight='bold')
  plt.xticks([r + barWidth for r in range(len(bars1))], scoresFrame.index)
  
  # Create legend & Show graphic
  plt.legend()
  plt.show()

drawMultipleScoreBarChart()
